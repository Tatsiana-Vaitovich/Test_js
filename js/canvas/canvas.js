...
let renderCloud = function(ctx, x, y, color) {
  ctx.fillStyle = color;
  ctx.fillRect(x, y, CLOUD_WIDTH - ClOUD_INDENT * ARR_INDENT, CLOUD_HEIGHT - ClOUD_INDENT * ARR_INDENT);
};

//вызовем функции отрисовки облака и тени
renderCloud(ctx, ClOUD_INDENT, ClOUD_INDENT,"#e5e5e5");
renderCloud(ctx, ClOUD_INDENT + 10, ClOUD_INDENT + 10, "rgba(129, 179, 210, 1)");
